...
- [SOC Project 🛡️](#soc-project----)
  ...
  * [📦 System Components Overview](#---system-components-overview)
    + [[**Wazuh Server**](https://wazuh.com/)](#---wazuh-server----https---wazuhcom--)
    + [[**Wazuh Indexer**](https://wazuh.com/)](#---wazuh-indexer----https---wazuhcom--)
    + [[**Wazuh Dashboard**](https://wazuh.com/)](#---wazuh-dashboard----https---wazuhcom--)
    + [[**Wazuh Agent**](https://wazuh.com/)](#---wazuh-agent----https---wazuhcom--)
    + [[**Wazuh Active Response**](https://documentation.wazuh.com/current/user-manual/capabilities/active-response/index.html)](#---wazuh-active-response----https---documentationwazuhcom-current-user-manual-capabilities-active-response-indexhtml-)
    + [[**Shuffle – SOAR**](https://github.com/frikky/Shuffle)](#---shuffle---soar----https---githubcom-frikky-shuffle-)
    + [[**TheHive**](https://thehive-project.org/)](#---thehive----https---thehive-projectorg--)
    + [[**Cortex**](https://github.com/TheHive-Project/Cortex)](#---cortex----https---githubcom-thehive-project-cortex-)
    + [[**Suricata**](https://suricata.io/)](#---suricata----https---suricataio--)
    + [[**VirusTotal**](https://www.virustotal.com/)](#---virustotal----https---wwwvirustotalcom--)
    + [[**Slack**](https://slack.com/)](#---slack----https---slackcom--)
    + [[**Technitium DNS Server**](https://technitium.com/dns/)](#---technitium-dns-server----https---technitiumcom-dns--)
  * [🚀 Deployment Overview](#---deployment-overview)
    + [1. Installing Wazuh](#1-installing-wazuh)
    + [2. Installing Wazuh Agents](#2-installing-wazuh-agents)
      - [🛠️ Common Issue: Duplicate Hostname](#----common-issue--duplicate-hostname)
